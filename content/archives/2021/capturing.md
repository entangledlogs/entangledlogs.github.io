...
Emacs offer a powerful [server](https://www.gnu.org/software/emacs/manual/html%5Fnode/emacs/Emacs-Server.html) that allows to clients which spawn frame equivalent to the editor window. Since
...
If you are confused (especially when starting out), that is totally normal. Emacs offer [hooks](https://www.gnu.org/software/emacs/manual/html%5Fnode/emacs/Hooks.html) that allows
